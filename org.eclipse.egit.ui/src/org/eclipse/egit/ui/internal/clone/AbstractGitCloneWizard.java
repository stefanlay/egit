...
public abstract class AbstractGitCloneWizard extends Wizard {
	 ...
	 */
	protected boolean performClone(URIish uri, UserPasswordCredentials credentials) {
	...
	private boolean hasReviewNotes(final URIish uri, int timeout, UserPasswordCredentials credentials) {
	...
	private void doGerritConfiguration(final String remoteName, final CloneOperation op, final boolean hasNotes) {
