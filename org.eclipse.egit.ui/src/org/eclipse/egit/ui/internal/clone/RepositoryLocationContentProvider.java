...
class RepositoryLocationContentProvider implements ITreeContentProvider {
	...
	private Map<RepositoryServerInfo, RepositoryImport> parents = new HashMap<RepositoryServerInfo, RepositoryImport>();
	...
	public Object[] getElements(Object inputElement) {
		...
		return repositoryImports.toArray(new RepositoryImport[repositoryImports
				.size()]);
	}
	...
	private void cacheParents(RepositoryImport repositoryImport,
